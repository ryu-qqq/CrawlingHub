...
resource "aws_kms_key" "logs" {
  description             = "KMS key for CrawlingHub web-api-prod CloudWatch logs encryption"
...
module "ecs_service" {
  ...
  health_check_start_period = 300 # Web API needs time to initialize JPA, Redis, and HTTP client connections
