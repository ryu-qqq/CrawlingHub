...
resource "aws_kms_key" "logs" {
  description             = "KMS key for CrawlingHub scheduler-prod CloudWatch logs encryption"
...
module "ecs_service" {
  ...
  health_check_start_period = 300 # Scheduler needs more time to initialize Redisson, Redis connections
