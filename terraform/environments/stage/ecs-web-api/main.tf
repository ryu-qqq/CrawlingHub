...
# Service Discovery DNS: crawlinghub-web-api-stage.connectly.local
# ========================================
...
resource "aws_kms_key" "logs" {
  description             = "KMS key for CrawlingHub web-api-stage CloudWatch logs encryption"
  ...
  custom_ingress_rules = [
    {
      ...
      description = "VPC internal traffic only (Service Discovery)"
    }
  ]
