# ========================================
# ECS Cluster for Crawlinghub (Stage)
# ========================================
# Dedicated ECS Cluster (not shared)
# Naming: crawlinghub-cluster-stage
# ========================================
...
resource "aws_ssm_parameter" "cluster_arn" {
  ...
  description = "Crawlinghub ECS cluster ARN (stage)"
  type        = "String"
...
resource "aws_ssm_parameter" "cluster_name" {
  ...
  description = "Crawlinghub ECS cluster name (stage)"
  type        = "String"
