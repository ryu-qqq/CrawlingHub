...
# ========================================
# Background scheduler service (No Auto Scaling)
...
locals {
  common_tags = {
    ...
    service_name = "${var.project_name}-scheduler-${var.environment}"
    team         = "platform-team"
...
resource "aws_kms_key" "logs" {
  description             = "KMS key for CrawlingHub scheduler-stage CloudWatch logs encryption"
