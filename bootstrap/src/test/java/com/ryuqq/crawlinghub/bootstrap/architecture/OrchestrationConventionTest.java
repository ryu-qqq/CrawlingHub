package com.ryuqq.crawlinghub.bootstrap.architecture;
...
class OrchestrationConventionTest {
    ...
    void orchestratorsShouldExtendBaseOrchestrator() {
        ArchRule rule = classes()
            ...
            .should().beAssignableTo("com.ryuqq.crawlinghub.application.common.orchestration.BaseOrchestrator")
    ...
    void executeInternalShouldReturnOutcome() {
        ArchRule rule = methods()
            .that().haveName("executeInternal")
            .and().areProtected()
            .should().haveRawReturnType("com.ryuqq.crawlinghub.application.common.orchestration.Outcome")
