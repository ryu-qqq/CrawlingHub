...
```
- [ ] 테스트 파일 생성
- [ ] 커밋: `test: UserAgentId, UserAgentStatus 테스트 추가 (Red)`
...
```
- [ ] 구현 완료
- [ ] 커밋: `feat: UserAgentId, UserAgentStatus 구현`

#### 🧹 Tidy
- [ ] UserAgentFixture 추가
- [ ] 커밋: `struct: UserAgent TestFixture 추가`
...
### 9️⃣ Cycle 9: Seller 활성화/비활성화 (15분)
...
```
- [ ] 테스트 추가
- [ ] 커밋: `test: Seller 활성화/비활성화 테스트 추가 (Red)`
