package com.ryuqq.crawlinghub.adapter.out.persistence.architecture.adapter.command;
...
class CommandAdapterArchTest {
    ...
    private static final String BASE_PACKAGE = "com.ryuqq.crawlinghub.adapter.out.persistence";
