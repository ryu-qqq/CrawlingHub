...
/**
 * CrawledProductSyncOutboxQueryAdapter - CrawledProductSyncOutbox Query Adapter
 *
 ...
 */
@Component
public class CrawledProductSyncOutboxQueryAdapter implements CrawledProductSyncOutboxQueryPort {
    ...
    public CrawledProductSyncOutboxQueryAdapter(
    ...
    public List<CrawledProductSyncOutbox> findFailedOlderThan(int limit, int delaySeconds) {
        List<ProductSyncOutboxJpaEntity> entities =
                queryDslRepository.findFailedOlderThan(limit, delaySeconds);
        return entities.stream().map(mapper::toDomain).toList();
    }
    ...
    public boolean existsByProductIdAndSyncTypeAndStatuses(
            Long productId, SyncType syncType, List<ProductOutboxStatus> statuses) {
        return queryDslRepository.existsByProductIdAndSyncTypeAndStatuses(
