 ...
 */
@Repository
public interface ScheduleOutboxJpaRepository
        extends JpaRepository<ScheduleOutboxEntity, Long> {
     ...
     */
    Optional<ScheduleOutboxEntity> findByOpId(String opId);
     ...
     * @return Outbox Entity (Optional)
     */
    Optional<ScheduleOutboxEntity> findByIdemKey(String idemKey);
     ...
     */
    List<ScheduleOutboxEntity> findBySellerIdOrderByCreatedAtDesc(Long sellerId);
     ...
     * @return Outbox Entity 목록
     */
    List<ScheduleOutboxEntity> findBySellerIdAndOperationState(
            Long sellerId,
     ...
     * @return Outbox Entity 목록
     */
    @Query("SELECT o FROM ScheduleOutboxEntity o "
            + "WHERE o.walState = :walState "
            + "ORDER BY o.createdAt ASC")
    List<ScheduleOutboxEntity> findByWalStateOrderByCreatedAtAsc(
    ...
    @Query("SELECT o FROM ScheduleOutboxEntity o "
            ...
            + "ORDER BY o.createdAt ASC")
    List<ScheduleOutboxEntity> findInProgressAndTimeout(
    ...
    @Query("SELECT o FROM ScheduleOutboxEntity o "
            ...
            + "ORDER BY o.createdAt ASC")
    List<ScheduleOutboxEntity> findRetryableFailed(
            @Param("operationState") OperationState operationState,
            Pageable pageable
    );
     ...
     * @return 삭제된 행 수
     */
    @Query("DELETE FROM ScheduleOutboxEntity o "
            + "WHERE o.operationState = :operationState "
