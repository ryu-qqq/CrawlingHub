...
/**
 * CrawlTaskOutboxJpaRepository - CrawlTaskOutbox JPA Repository
 *
 ...
 * @since 1.0.0
 */
public interface CrawlTaskOutboxJpaRepository
        extends JpaRepository<CrawlTaskOutboxJpaEntity, Long> {}
