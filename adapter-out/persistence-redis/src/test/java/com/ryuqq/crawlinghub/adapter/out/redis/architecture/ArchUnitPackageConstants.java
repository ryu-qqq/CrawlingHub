package com.ryuqq.crawlinghub.adapter.out.redis.architecture;
...
public final class ArchUnitPackageConstants {
    ...
    /** 프로젝트 기본 패키지 (루트 패키지) */
    public static final String BASE_PACKAGE = "com.ryuqq.crawlinghub";
    ...
    public static final String REDIS = BASE_PACKAGE + ".adapter.out.redis";
