package com.ryuqq.crawlinghub.application.architecture.port.out;
...
class QueryPortArchTest {
    ...
    void queryPort_SearchMethodsShouldReturnPageResponse() {
        ...
        ArchRule rule = methods()
            ...
            .should().haveRawReturnType("com.ryuqq.crawlinghub.application.common.dto.response.PageResponse")
