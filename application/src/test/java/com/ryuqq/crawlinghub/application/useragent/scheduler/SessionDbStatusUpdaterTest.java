 ...
 *
 * <p>Mockist 스타일 테스트: ReadManager, TransactionManager, TimeProvider Mocking
 *
...
class SessionDbStatusUpdaterTest {
    ...
    @BeforeEach
    void setUp() {
        updater = new SessionDbStatusUpdater(readManager, transactionManager, timeProvider);
        fixedTime = Instant.parse("2024-01-15T10:00:00Z");
    }
