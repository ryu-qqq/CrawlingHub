package com.ryuqq.crawlinghub.application.architecture.dto;
...
class DtoRecordArchTest {
    ...
    @BeforeAll
    static void setUp() {
        classes = new ClassFileImporter().importPackages("com.ryuqq.crawlinghub.application");
        ...
        void dto_MustNotReturnDomainObjects() {
            ...
            ArchRule rule =
                    noMethods()
                            ...
                            .arePublic()
                            .should()
                            .haveRawReturnType("com.ryuqq.crawlinghub.domain..")
