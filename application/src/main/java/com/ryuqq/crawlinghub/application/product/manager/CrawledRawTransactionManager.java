...
public class CrawledRawTransactionManager {
     ...
     */
    @Transactional
    public CrawledRawId markAsProcessed(CrawledRaw crawledRaw, Instant now) {
        CrawledRaw processed = crawledRaw.markAsProcessed(now);
     ...
     */
    @Transactional
    public CrawledRawId markAsFailed(CrawledRaw crawledRaw, String errorMessage, Instant now) {
        CrawledRaw failed = crawledRaw.markAsFailed(errorMessage, now);
