 ...
 * @since 1.0.0
 */
public interface RecoverTimeoutSchedulerOutboxUseCase {
     ...
     */
    SchedulerBatchProcessingResult execute(RecoverTimeoutSchedulerOutboxCommand command);
}
