...
class CrawlTaskStatusTest {
    ...
    class IsInProgressTest {
        ...
        @ParameterizedTest
        @EnumSource(value = CrawlTaskStatus.class, names = {"WAITING", "PUBLISHED", "RUNNING"})
        ...
        @ParameterizedTest
        @EnumSource(value = CrawlTaskStatus.class, names = {"SUCCESS", "FAILED", "RETRY", "TIMEOUT"})
    ...
    class IsTerminalTest {
        ...
        @ParameterizedTest
        @EnumSource(value = CrawlTaskStatus.class, names = {"SUCCESS", "FAILED"})
        ...
        @ParameterizedTest
        @EnumSource(value = CrawlTaskStatus.class, names = {"WAITING", "PUBLISHED", "RUNNING", "RETRY", "TIMEOUT"})
