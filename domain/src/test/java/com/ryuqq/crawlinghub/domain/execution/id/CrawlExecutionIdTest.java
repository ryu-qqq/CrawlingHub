...
@Tag("domain")
@Tag("id")
@DisplayName("CrawlExecutionId Value Object 단위 테스트")
class CrawlExecutionIdTest {
    ...
    class ForNewTest {
        ...
        void createWithNullValue() {
            CrawlExecutionId id = CrawlExecutionId.forNew();
    ...
    class OfTest {
        ...
        void createWithValidValue() {
            CrawlExecutionId id = CrawlExecutionId.of(1L);
        ...
        void nullValueThrowsException() {
            assertThatThrownBy(() -> CrawlExecutionId.of(null))
    ...
    class DirectCreationValidationTest {
        ...
        void zeroValueThrowsException() {
            assertThatThrownBy(() -> new CrawlExecutionId(0L))
                    .isInstanceOf(IllegalArgumentException.class)
        ...
        void negativeValueThrowsException() {
            assertThatThrownBy(() -> new CrawlExecutionId(-1L))
                    .isInstanceOf(IllegalArgumentException.class)
                    .hasMessageContaining("양수");
        }
        ...
        void nullIsAllowed() {
            CrawlExecutionId id = new CrawlExecutionId(null);
            assertThat(id.value()).isNull();
            assertThat(id.isNew()).isTrue();
        }
    }
    ...
    class EqualityTest {
        ...
        void sameValueAreEqual() {
            CrawlExecutionId id1 = CrawlExecutionId.of(1L);
            CrawlExecutionId id2 = CrawlExecutionId.of(1L);
        ...
        void differentValuesAreNotEqual() {
            CrawlExecutionId id1 = CrawlExecutionId.of(1L);
            CrawlExecutionId id2 = CrawlExecutionId.of(2L);
