package com.ryuqq.crawlinghub.domain.architecture.query;
    ...
    void criteria_ShouldNotDependOnOuterLayers() {
        ArchRule rule =
                classes()
                        ...
                        .resideInAnyPackage(
                                "com.ryuqq.crawlinghub.domain..", "java..", "jakarta.annotation..")
                        .allowEmptyShould(true)
                        .because(
    ...
    void criteria_ShouldUseCommonVOs() {
        ...
        ArchRule rule =
                classes()
                        ...
                        .accessClassesThat()
                        .resideInAnyPackage(
                                "com.ryuqq.crawlinghub.domain.common.vo..",
                                "com.ryuqq.crawlinghub.domain..vo..",
                                "java..",
                                "com.ryuqq.crawlinghub.domain..query.criteria..")
                        .orShould()
                        .accessClassesThat()
