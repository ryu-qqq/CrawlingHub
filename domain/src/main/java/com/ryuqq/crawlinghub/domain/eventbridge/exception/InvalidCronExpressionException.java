 ...
 *
 * <p>AWS EventBridge 형식 위반 또는 최소 실행 간격 위반 시 발생합니다.</p>
 */
public final class InvalidCronExpressionException extends DomainException {
    ...
    public static InvalidCronExpressionException dueToInvalidFormat(String expression) {
        String message = String.format(
            "Cron expression must follow AWS EventBridge format 'cron(minute hour day-of-month month day-of-week year)': %s",
            expression
        );
