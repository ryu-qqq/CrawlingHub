 ...
 * <ul>
 *   <li>잘못된 상태에서 publish() 시도</li>
 *   <li>잘못된 상태에서 start() 시도</li>
 ...
 *   <li>Message: "Cannot {action} task. Current status: {status}. Reason: {reason}"</li>
 * </ul>
 *
 * @author ryu-qqq
 * @since 2025-11-17
...
public class CrawlerTaskInvalidStateException extends DomainException {
     ...
     * @since 2025-11-17
     */
    public CrawlerTaskInvalidStateException(String message) {
        super(message);
    }
