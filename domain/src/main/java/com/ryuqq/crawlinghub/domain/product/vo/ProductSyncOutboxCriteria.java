...
/**
 * ProductSyncOutbox 조회 조건 Value Object
 *
 ...
 * ProductSyncOutboxCriteria.pendingOrFailed(100);
 *
 * // 재시도 가능한 Outbox 조회 (PENDING OR FAILED + 재시도 횟수 제한)
 * ProductSyncOutboxCriteria.retryable(3, 100);
 * </pre>
 *
 ...
 * @since 1.0.0
 */
public record ProductSyncOutboxCriteria(
    ...
    public ProductSyncOutboxCriteria {
        if (offset < 0) {
     ...
     * @param limit 조회 개수 제한
     * @return ProductSyncOutboxCriteria
     */
    public static ProductSyncOutboxCriteria byStatus(ProductOutboxStatus status, int limit) {
        return new ProductSyncOutboxCriteria(status, null, null, null, null, 0, limit);
    }
     ...
     * @return ProductSyncOutboxCriteria
     */
    public static ProductSyncOutboxCriteria byStatuses(
            List<ProductOutboxStatus> statuses, int limit) {
        return new ProductSyncOutboxCriteria(null, statuses, null, null, null, 0, limit);
    }
     ...
     * @return ProductSyncOutboxCriteria
     */
    public static ProductSyncOutboxCriteria pendingOrFailed(int limit) {
        return new ProductSyncOutboxCriteria(
                null,
     ...
     * @return ProductSyncOutboxCriteria
     */
    public static ProductSyncOutboxCriteria retryable(int maxRetryCount, int limit) {
        return new ProductSyncOutboxCriteria(
                null,
                List.of(ProductOutboxStatus.PENDING, ProductOutboxStatus.FAILED),
                null,
     ...
     * @return ProductSyncOutboxCriteria
     */
    public static ProductSyncOutboxCriteria withDateRange(
            List<ProductOutboxStatus> statuses,
            Instant createdFrom,
            Instant createdTo,
            int offset,
