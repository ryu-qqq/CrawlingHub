 ...
 *
 * <p>모든 Bounded Context의 ErrorCode Enum이 구현해야 하는 인터페이스입니다.</p>
 *
 * <p><strong>설계 원칙:</strong></p>
 * <ul>
 *   <li>✅ 형식: {BC}-{3자리 숫자} (예: SELLER-001, CRAWLER-001)</li>
 *   <li>✅ HTTP 상태 코드 매핑 (404, 400, 409, 500 등)</li>
 *   <li>✅ 명확한 에러 메시지</li>
 * </ul>
 *
...
public interface ErrorCode {
     ...
     *
     * <p>형식: {BC}-{3자리 숫자}</p>
     * <p>예: SELLER-001, CRAWLER-001, PRODUCT-001</p>
     *
     * @return 에러 코드 문자열
     * @author ryu-qqq
     * @since 2025-11-17
