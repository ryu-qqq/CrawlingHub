...
public final class InvalidCrawlTaskStateException extends DomainException {
    ...
    private static final CrawlTaskErrorCode ERROR_CODE = CrawlTaskErrorCode.INVALID_CRAWL_TASK_STATE;
     ...
     */
    public InvalidCrawlTaskStateException(CrawlTaskStatus currentStatus, CrawlTaskStatus expectedStatus) {
        super(
                ERROR_CODE.getCode(),
