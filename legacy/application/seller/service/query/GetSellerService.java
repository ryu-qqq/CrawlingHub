...
public class GetSellerService implements GetSellerUseCase {
    ...
    public SellerDetailResponse getSeller(GetSellerQuery query) {
        ...
        int activeSchedulerCount =
                schedulerQueryPort.countActiveSchedulersBySellerId(query.sellerId());
        int totalSchedulerCount =
                schedulerQueryPort.countTotalSchedulersBySellerId(query.sellerId());
        return sellerAssembler.toSellerDetailResponse(
                seller, activeSchedulerCount, totalSchedulerCount);
    }
}
