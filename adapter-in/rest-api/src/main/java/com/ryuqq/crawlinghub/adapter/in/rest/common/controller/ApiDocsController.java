 ...
 *
 * <p>모든 문서 경로를 {@code /api/v1/crawling} 하위로 통합하여 API Gateway 라우팅 패턴과 일치시킵니다.
 *
 * <p><strong>접근 경로:</strong>
 *
 * <ul>
 *   <li>{@code /api/v1/crawling/docs} - REST Docs 메인 페이지
 *   <li>{@code /api/v1/crawling/swagger} - Swagger UI
 *   <li>{@code /api/v1/crawling/api-docs} - OpenAPI JSON (springdoc)
 * </ul>
 *
 * @author ryu-qqq
 * @since 1.0.0
...
public class ApiDocsController implements WebMvcConfigurer {
    ...
    private static final String DOCS_BASE = "/api/v1/crawling";
     ...
     * /api/v1/crawling/swagger-ui/} 하위로 직접 서빙합니다.
     *
     * @return 리다이렉트 경로
     */
     ...
     *
     * <p>swagger-ui webjar의 리소스를 {@code /api/v1/crawling/swagger-ui/} 경로에서 서빙합니다. webjar 내부의 버전
     * 디렉토리는 classpath 스캔으로 자동 감지합니다.
     */
    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        // REST Docs: /api/v1/crawling/docs/** → classpath:/static/api/v1/crawling/docs/
        registry.addResourceHandler(DOCS_BASE + "/docs/**")
                .addResourceLocations("classpath:/static/api/v1/crawling/docs/");
