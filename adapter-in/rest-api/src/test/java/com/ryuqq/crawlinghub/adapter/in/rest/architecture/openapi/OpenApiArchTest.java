...
@Tag("architecture")
@Tag("adapter-rest")
@Disabled("Domain Layer 리팩토링 이후 아키텍처 이슈 별도 해결 필요")
class OpenApiArchTest {
    ...
    class ControllerOpenApiRules {
         ...
         *
         * <p>예외: Legacy V1 API, ApiDocsController는 점진적 마이그레이션/문서 서빙용으로 제외
         */
        @Test
        ...
        void commandRequestDto_ShouldHaveSchema() {
            ArchRule rule =
                    classes()
                            ...
                            .allowEmptyShould(true)
                            .because("Request DTO는 @Schema로 문서화해야 합니다 (Legacy V1 제외)");
        ...
        void queryConditionDto_ShouldHaveSchema() {
            ArchRule rule =
                    classes()
                            ...
                            .beAnnotatedWith("io.swagger.v3.oas.annotations.media.Schema")
                            .allowEmptyShould(true)
                            .because("Query 조건 DTO는 @Schema로 문서화해야 합니다 (Legacy V1 제외)");
        ...
        void responseDto_ShouldHaveSchema() {
            ArchRule rule =
                    classes()
                            ...
                            .beAnnotatedWith("io.swagger.v3.oas.annotations.media.Schema")
                            .allowEmptyShould(true)
                            .because("Response DTO는 @Schema로 문서화해야 합니다 (Legacy V1 제외)");
        ...
        void dtoFields_ShouldHaveSchema() {
            ...
            ArchRule requestRule =
                    classes()
                            ...
                            .allowEmptyShould(true)
                            .because("Request DTO의 모든 필드는 @Schema로 문서화해야 합니다 (Legacy V1 제외)");

            // Response DTO 규칙 (common 패키지의 유틸리티 클래스 제외, Legacy V1 제외)
            ArchRule responseRule =
                    classes()
                            ...
                            .should(haveSchemaOnAllRecordComponents())
                            .allowEmptyShould(true)
                            .because("Response DTO의 모든 필드는 @Schema로 문서화해야 합니다 (Legacy V1 제외)");
        ...
        void schema_ShouldHaveDescription() {
            ArchRule rule =
                    classes()
                            ...
                            .allowEmptyShould(true)
                            .because("@Schema의 description은 필수입니다 (Legacy V1 제외)");
        ...
        void enum_ShouldHaveSchema() {
            ArchRule rule =
                    classes()
                            ...
                            .beAnnotatedWith("io.swagger.v3.oas.annotations.media.Schema")
                            .allowEmptyShould(true)
                            .because("Enum은 @Schema로 문서화해야 합니다 (Legacy V1 제외)");
