...
public class CrawlTaskSqsListener {
     ...
     */
    @SqsListener(value = "${aws.sqs.listener.crawl-task-queue-url}", acknowledgementMode = "MANUAL")
    public void handleMessage(@Payload CrawlTaskPayload payload, Acknowledgement acknowledgement) {
        ...
        boolean lockAcquired =
                lockExecutor.tryExecuteWithLock(
                        LockType.CRAWL_TASK, taskId, () -> executeCrawlTask(payload));
